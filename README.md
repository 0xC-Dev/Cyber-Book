...
> Note that these notes were compiled while studying for PJPT (Completed), CRTP (Completed), and OSCP. AI was used to restructure them into this publishing format.
