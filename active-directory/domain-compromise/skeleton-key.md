...
| **Use when** | Lab only | Long-term persistence | Backup DA | Stealthy service access |

**Rule of thumb:** Lab only. Real engagement -> use Golden / Silver / Diamond instead.
